...
## Conversation confirmed and calmer voice applied — 2026-09-13

William confirmed live two-way Discord voice conversation works. Earlier ignored text used the Herald role mention rather than the bot user; native /voice join is now registered and usable. Join General voice, then select Herald's native /voice command with mode join in #general.
