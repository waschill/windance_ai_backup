...
- William identified his current iPhone IP as 192.168.36.215. Router DHCP agrees it is an iPhone; live conntrack shows established, bidirectional Internet connections from this IP. A subsequent approximately 30-second observation saw no phone UDP 500/4500 registration entries. The airplane-mode test result has not yet been supplied; this observation does not demonstrate that the phone tried to register during the sample.
