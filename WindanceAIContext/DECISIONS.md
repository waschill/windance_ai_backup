...
- William's primary routine communication channel is Telegram as of 2026-09-03 so reports are available on phone and computer. Email-management reports remain on their established iMessage path because they are easier to manage there. Urgent, exception, outage, security, and recovery alerts remain on Max/iMessage so William's special notification sound is preserved. Shawn-facing reports remain on Shawn's established route unless she requests a change.
